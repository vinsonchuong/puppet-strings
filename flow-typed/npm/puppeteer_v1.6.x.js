...
declare module 'puppeteer' {
  ...
  declare type EvaluateFn = string | ((...args: Array<any>) => any);
  ...
  declare type ExecutionContext = {
    evaluate(fn: EvaluateFn, ...args: Array<any>): Promise<any>,
    evaluateHandle(fn: EvaluateFn, ...args: Array<any>): Promise<JSHandle>,
  ...
  declare interface Page extends OverridableEventEmitter, FrameBase {
     ...
     * @param args The arguments to pass to the `fn`.
     */
    evaluateOnNewDocument(fn: EvaluateFn, ...args: Array<any>): Promise<void>;
